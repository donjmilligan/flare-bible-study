...
<head>
  ...
  <title>Empires In Prophecy</title>
...
<body>
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent2">
                      ...
                      <div class="tab-pane fade show tabcontent active" id="about" role="tabpanel" aria-labelledby="profile-tab3">
                        <div class="clear"></div> 
                        <h1><span class="fi55">Empires In Prophecy</span></h1>
                        <h2 class="fi77">Studying Daniel and Revelation</h2>
                        <div class="clear"></div> 
                                    ...
                                    <div class="quotecontent"><i class="mdi mdi-format-quote-open"></i><p class="text_justify fi12">"But know this first of all, that no prophecy of Scripture is a matter of one's own interpretation".’ </p></div>
                                    <div class="verse-container book fi10">2nd Peter <span>1:20</span></div>
                                    <div class="clear"></div>
  ...
  <script> $(function(){ plotHierarchicalEdgeBundling("data/studies/flare-EmpiresInProphecy.json"); }); </script>
