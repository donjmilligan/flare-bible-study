...
<head>
  ...
  <title>Messages of Hope: FBS</title>
...
<body>
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent2">
                      ...
                      <div class="tab-pane fade show tabcontent active" id="about" role="tabpanel" aria-labelledby="profile-tab3">
                        <div class="clear"></div>
                        <h1><span class="fi55">A Message with <u>H</u>ope</span></h1>
                        <h2 class="fi10">Gods tender mercies and His promises</h2>
                        <div class="clear"></div>    
                                   <p>Here is a little starter map -<span> on hope</span><br/></p>
                                   <div class="clear"></div>
                                   <div class="quotecontent"><i class="mdi mdi-format-quote-open"></i><p class="text_justify fi33"> When you go through the waters, I will be with you; and through the rivers, they will not go over you: when you go through the fire, you will not be burned; and the flame will have no power over you. For I am the Lord your God, the Holy One of Israel, your Saviour </p></div>
                                   <div class="verse-container book animate_content"><span>--These promises can go a long way when times are tough</span></div><br/>
                                   <div class="verse-container book animate_content">Isaiah 43:1-3</div>
                        <div class="clear"></div>
  ...
  <script> $(function(){ plotHierarchicalEdgeBundling("data/studies/flare-hope.json"); }); </script>
