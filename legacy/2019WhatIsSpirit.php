...
<body>
    ...
    <div class="main-wrapper main-wrapper-1">
                  ...
                  <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent2">
                      ...
                      <div class="tab-pane fade show tabcontent active" id="about" role="tabpanel" aria-labelledby="profile-tab3">
                                   <div class="clear"></div>
                        <h1><span class="fi55">What is spirit?</span></h1>
                        <h2 class="fi10">It is consciousness</h2>
                        <div class="clear"></div>
                        <p>The word <i>spirit</i> shows up 499 times in the King James Version of the bible. Spirit is a Greek word and has experienced some morphology in meaning over time. However, we can understand the original truth about what spirit precisely means from a biblical perspective. Comparing all of the verses containing the Heberew word רוּח English: ruach, pronounced (roo'-akh), with the new testament verses using the word Spirit left me satisfied, and kind of amazed at God actually. </p>
                        <p>Spirit is just plain old consciousness. Animals also have spirit (Ecclesiastes 3:21), but plants don't, and we don't even really have to reason with it too much, because God told us this very understanding through the apostle Paul.</p>
                        <table class="blockquote">
                            <tr>
                                <td valign="top"><i class="mdi mdi-format-quote-open"></i></td>
                                <td><p><br>These things God has revealed to us through the Spirit. For the Spirit searches everything, even the depths of God. for who knows a person's thoughts except the spirit of that person, which is in him? So also no one comprehends the thoughts of God except the Spirit of God. Now we have received not the spirit of the world, but the Spirit who is from God, that we might understand the things freely given us by God  . And we impart this in words not taught by human wisdom but taught by the Spirit, interpreting spiritual truths to those who are spiritual.</p>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
                                <td class="book">1st Corinthians&nbsp;<span>1:10-13</span></td>
                            </tr>
                        </table>
                        <div class="clear"></div>
                        <h3>Part I: Genesis to Ecclesiastes</h3> 
                        <div class="clear"></div>
                        <p><span>I have been studying this epiphany for a couple years now, and have studied every verse to be sure</span>.<br>For every verse containing the word <i>spirit</i>, consciousness is always the base contextual concept. We can read the entire bible and use the phrase 'State of awareness' every time the word spirit shows up, and it always works.</p>

                        <p>According to 1st Corinthians 1:10-13, a <i>state of awareness</i> (spirit) is what perceives thoughts in the mind, physical sense, emotion, and feelings. A state of awareness can be a group thing (ie: team spirit), it can be an unseen presence (ie: a clean or unclean angel), or even a body of conscious understanding. Any conscious way of thinking falls under one of two spirits: either a for truth or for deceit, and only the truth is for love.</p>

                           <p>When it comes to Gods Holy Spirit, it is his own state of awareness. God has some pretty loving and powerful Thoughts -- even for you and me. I'm certain it's pretty low on the list of things He can do but God can transport people from one place to another with nothing but his Spirit (for example Ezekiel or the disciple John in Revelation). </p><br/>
                        <h4>Other Examples</h4>
                        <p>There are at least three places in the bible where someone has little or no spirit, but they still have a soul (they are unconscious) and someone gives them water, food, or good news and their spirit returns to them. In other places, like in Daniel chapter 10, people witness a spiritual event differently while they are near each other physically. This is because spiritual things happen - well, spiritually, in our state of awareness.</p>
                        <p>I truly believe that God solely has the power to change things with his consciousness. The devil is left to most typically left to tempting us with his own consciousness, and only gets the opportunity for more if God allows it. We see this happen in the book of Job when calamity falls on Jobs family. What intrigues me most in that bit of the story is that Satan never breaks the rules that God sets, although he does come back to argue whether or not the rule is just.</p>

                        <p>we can have faith in Gods power to protect us, even by his Spirit, after all He's the one who first said to Abraham, "I am thy shield, and thy exceeding great reward," and he said it no doubt, by his Holy Spirit.</p>

                        <h6>This study covers many of the verses. We'll need a part 2 and maybe even 3 to complete it using subject mapping. </h6>

                        
                        
                        <div class="clear"></div>
                        <div class="or-spacer"><div class="spacer-mask2"></div></div>
                        <div class="clear"></div>
                      </div>
      ...
      <footer class="main-footer">
        <div class="footer-left">
         MIT Copyright &copy; 2019 <div class="bullet"></div> Web Sites by<a href="https://freelancedon.ca/">Don Milligan</a>
        </div>
  ...
  <script src="./assets/js/flare-biblestudy.js?042"></script>
  <script> $(function(){ plotHierarchicalEdgeBundling("data/studies/flare-spirit.json"); }); </script>
