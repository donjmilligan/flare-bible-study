// Modified version of
// https://github.com/stisla/stisla/blob/master/assets/js/scripts.js
...
$(function () {
  ...
  var toggle_sidebar_mini = function (mini) {
    ...
    if (!mini) {
      ...
      if ($(".navbar-bg.nav-white")) {
        $(".navbar-bg").removeClass("nav-white");
      }
      setTimeout(function () {
        $(".main-sidebar").niceScroll(sidebar_nicescroll_opts);
        sidebar_nicescroll = $(".main-sidebar").getNiceScroll();
  ...
  $(".notification-toggle")
    ...
    .on("shown.bs.dropdown", function () {
      $(".nav-link.notification-toggle.nav-link-lg.beep").removeClass("beep");
