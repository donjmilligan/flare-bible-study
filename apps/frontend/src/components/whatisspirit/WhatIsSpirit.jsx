...
export default function WhatisSpirit() {
  ...
  useEffect(() => {
    ...
    function linkPath(link) {
      const startAngle = (link.source.x - 90) * (Math.PI / 180);
      const endAngle = (link.target.x - 90) * (Math.PI / 180);
      const startRadius = link.source.y;
      const endRadius = link.target.y;
      ...
      // Control point at the center for a smooth curve
  ...
  return (
    <div className="page-content" style={{ position: "relative" }}>
      ...
      <div
        ...
        style={{
          position: "fixed",
          top: 70, // match D3 diagram marginTop
          right: 20,
          width: 270,
          minHeight: 180,
          maxHeight: "80vh",
          ...
          padding: 12,
          overflowY: "auto",
          marginRight: 8, // leave space for scrollbar
        }}
      >
        <h4 style={{ fontSize: 16, margin: "0 0 8px 0" }}>Info</h4>
        {selectedNode ? (
          <div>
            ...
            <div style={{ fontSize: 12 }}>Cross-references:</div>
          ...
          <div style={{ fontSize: 12 }}>Select a node to see details.</div>
        )}
      ...
      <div
        style={{
          ...
          marginRight: 170, // leave space for info panel on right
          maxWidth: WIDTH + 220,
        }}
      >
        <div
