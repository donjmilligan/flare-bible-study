...
router.get("/worldempire", async (req, res) => {
  try {
...
router.post("/worldempire", async (req, res) => {
...
router.delete("/worldempire/:name", async (req, res) => {
...
router.patch("/worldempire/:name", async (req, res) => {
