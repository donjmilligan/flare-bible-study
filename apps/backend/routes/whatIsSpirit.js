...
router.get("/whatisspirit", async (req, res) => {
  try {
...
router.post("/whatisspirit", async (req, res) => {
...
router.delete("/whatisspirit/:name", async (req, res) => {
...
router.patch("/whatisspirit/:name", async (req, res) => {
