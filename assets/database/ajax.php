<?php
//ini_set('display_errors', 1);/// for debugging: prints ERROR LOGGING to the page
//error_reporting(E_ALL);/// for debugging: prints ERROR LOGGING to the page
/* 
 * orignally from my fork of bible_to_sql @ https://github.com/donaldmilligan/bible_databases/blob/master/web/ajax.php 
